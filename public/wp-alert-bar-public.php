            ...
            <div class="wrap">
                <p class="mbwpab-alert-message">
                    ...
                    <?php if ( get_option( 'cta' ) ) { ?>
                        <span class="mbwpab-alert-cta-sep">-</span> <a href="<?php echo get_option( 'cta_link' ); ?>"<?php if ( true === get_theme_mod( 'cta_target_blank' ) ) { echo ' target="_blank"'; }?> class="mbwpab-alert-title"><?php echo get_option( 'cta' ); ?></a>
                    <?php } ?> 
                </p>
